    ...
    <Link to={`/${film.id}`} className="reviewCard">
      ...
      <div className="reviewCard_body">
        <div className="reviewCard_user">
          <div className="reviewCard_user_avatar"></div>
          <span className="reviewCard_user_name">Islam Sayed</span>
        </div>
        <h3 className="reviewCard_title">{film.title}</h3>
        <span className="reviewCard_date">
          {film.release_date.substring(0, 4)}
        </span>
        <div className="reviewCard_rate"> ★★★★★ </div>
        <p className="reviewCard_review">
